...
const char * const BITCOIN_CONF_FILENAME = "NyanCoin.conf";
const char * const BITCOIN_PID_FILENAME = "NyanCoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/NyanCoin";
#else
    // Unix
